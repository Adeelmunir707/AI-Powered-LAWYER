...
def main():
    ...
    if pdf_path:
        ...
        if os.path.exists(f"{store_name}.pkl"):
            ...
            embeddings = OpenAIEmbeddings(openai_api_key="sk-abcd1234efgh5678abcd1234efgh5678abcd1234")
        ...
        if query:
            ...
            llm = OpenAI(openai_api_key="sk-abcd1234efgh5678abcd1234efgh5678abcd1234")
